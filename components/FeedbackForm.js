...
const FeedbackForm = () => {
      ...
      <div>
        ...
        <input type="email" id="gh-feedback-sender-email" name="email" placeholder="Type your email... (optional)" value={ formValues.email } onChange={handleChange} className="bg-white dark:bg-neutral-800 text-slate-900 dark:text-white"/>
      </div>
      <div>
